...
public class TestContextBootstrapInitializer {
  public static Map<String, Supplier<SmartContextLoader>> getContextLoaders() {
    ...
    entries.put("com.alex3d.biblioteca.BibliotecaApplicationTests", () -> new AotSpringBootConfigContextLoader(BibliotecaApplicationTestsContextInitializer.class, WebApplicationType.SERVLET, SpringBootTest.WebEnvironment.MOCK));
    return entries;
  }
  ...
  public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializers(
    ...
    entries.put("com.alex3d.biblioteca.BibliotecaApplicationTests", BibliotecaApplicationTestsContextInitializer.class);
    return entries;
  }
}
